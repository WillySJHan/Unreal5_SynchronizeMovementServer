...
extern UC_LEAVE_GAMEDefaultTypeInternal _UC_LEAVE_GAME_default_instance_;
class UC_LOGIN;
...
template<> ::Protocol::UC_LEAVE_GAME* Arena::CreateMaybeMessage<::Protocol::UC_LEAVE_GAME>(Arena*);
...
class UC_LEAVE_GAME final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:Protocol.UC_LEAVE_GAME) */ {
 public:
  inline UC_LEAVE_GAME() : UC_LEAVE_GAME(nullptr) {}
  explicit PROTOBUF_CONSTEXPR UC_LEAVE_GAME(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  UC_LEAVE_GAME(const UC_LEAVE_GAME& from);
  UC_LEAVE_GAME(UC_LEAVE_GAME&& from) noexcept
    : UC_LEAVE_GAME() {
    *this = ::std::move(from);
  }

  inline UC_LEAVE_GAME& operator=(const UC_LEAVE_GAME& from) {
    CopyFrom(from);
    return *this;
  }
  inline UC_LEAVE_GAME& operator=(UC_LEAVE_GAME&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const UC_LEAVE_GAME& default_instance() {
    return *internal_default_instance();
  }
  static inline const UC_LEAVE_GAME* internal_default_instance() {
    return reinterpret_cast<const UC_LEAVE_GAME*>(
               &_UC_LEAVE_GAME_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(UC_LEAVE_GAME& a, UC_LEAVE_GAME& b) {
    a.Swap(&b);
  }
  inline void Swap(UC_LEAVE_GAME* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(UC_LEAVE_GAME* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  UC_LEAVE_GAME* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<UC_LEAVE_GAME>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyFrom;
  inline void CopyFrom(const UC_LEAVE_GAME& from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::CopyImpl(*this, from);
  }
  using ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeFrom;
  void MergeFrom(const UC_LEAVE_GAME& from) {
    ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase::MergeImpl(*this, from);
  }
  public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.UC_LEAVE_GAME";
  }
  protected:
  explicit UC_LEAVE_GAME(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:Protocol.UC_LEAVE_GAME)
 private:
  class _Internal;
...
inline ::Protocol::ObjectInfo* MS_LOGIN::mutable_players(int index) {
...
inline const ::Protocol::ObjectInfo& MS_LOGIN::_internal_players(int index) const {
  return _impl_.players_.Get(index);
}
inline const ::Protocol::ObjectInfo& MS_LOGIN::players(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.MS_LOGIN.players)
  return _internal_players(index);
}
inline ::Protocol::ObjectInfo* MS_LOGIN::_internal_add_players() {
  return _impl_.players_.Add();
}
inline ::Protocol::ObjectInfo* MS_LOGIN::add_players() {
...
// repeated .Protocol.ObjectInfo players = 1;
inline int MS_SPAWN::_internal_players_size() const {
  return _impl_.players_.size();
}
inline int MS_SPAWN::players_size() const {
  return _internal_players_size();
}
inline ::Protocol::ObjectInfo* MS_SPAWN::mutable_players(int index) {
  // @@protoc_insertion_point(field_mutable:Protocol.MS_SPAWN.players)
  return _impl_.players_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::ObjectInfo >*
MS_SPAWN::mutable_players() {
  // @@protoc_insertion_point(field_mutable_list:Protocol.MS_SPAWN.players)
  return &_impl_.players_;
}
inline const ::Protocol::ObjectInfo& MS_SPAWN::_internal_players(int index) const {
  return _impl_.players_.Get(index);
}
inline const ::Protocol::ObjectInfo& MS_SPAWN::players(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.MS_SPAWN.players)
  return _internal_players(index);
}
inline ::Protocol::ObjectInfo* MS_SPAWN::_internal_add_players() {
  return _impl_.players_.Add();
}
inline ::Protocol::ObjectInfo* MS_SPAWN::add_players() {
  ::Protocol::ObjectInfo* _add = _internal_add_players();
  // @@protoc_insertion_point(field_add:Protocol.MS_SPAWN.players)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::ObjectInfo >&
MS_SPAWN::players() const {
  // @@protoc_insertion_point(field_list:Protocol.MS_SPAWN.players)
  return _impl_.players_;
}
...
inline uint64_t MS_DESPAWN::_internal_object_ids(int index) const {
  return _impl_.object_ids_.Get(index);
}
inline uint64_t MS_DESPAWN::object_ids(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.MS_DESPAWN.object_ids)
  return _internal_object_ids(index);
}
inline void MS_DESPAWN::set_object_ids(int index, uint64_t value) {
  _impl_.object_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:Protocol.MS_DESPAWN.object_ids)
}
inline void MS_DESPAWN::_internal_add_object_ids(uint64_t value) {
  _impl_.object_ids_.Add(value);
}
inline void MS_DESPAWN::add_object_ids(uint64_t value) {
...
// .Protocol.PosInfo info = 1;
inline bool UC_MOVE::_internal_has_info() const {
  return this != internal_default_instance() && _impl_.info_ != nullptr;
}
inline bool UC_MOVE::has_info() const {
  return _internal_has_info();
}
inline const ::Protocol::PosInfo& UC_MOVE::_internal_info() const {
...
inline const ::Protocol::PosInfo& UC_MOVE::info() const {
  // @@protoc_insertion_point(field_get:Protocol.UC_MOVE.info)
  return _internal_info();
}
inline void UC_MOVE::unsafe_arena_set_allocated_info(
    ::Protocol::PosInfo* info) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Protocol.UC_MOVE.info)
}
inline ::Protocol::PosInfo* UC_MOVE::release_info() {
...
inline ::Protocol::PosInfo* UC_MOVE::unsafe_arena_release_info() {
  // @@protoc_insertion_point(field_release:Protocol.UC_MOVE.info)
  
  ::Protocol::PosInfo* temp = _impl_.info_;
  _impl_.info_ = nullptr;
  return temp;
}
inline ::Protocol::PosInfo* UC_MOVE::_internal_mutable_info() {
...
inline ::Protocol::PosInfo* UC_MOVE::mutable_info() {
  ::Protocol::PosInfo* _msg = _internal_mutable_info();
  // @@protoc_insertion_point(field_mutable:Protocol.UC_MOVE.info)
  return _msg;
}
inline void UC_MOVE::set_allocated_info(::Protocol::PosInfo* info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.info_);
  }
  ...
  _impl_.info_ = info;
  // @@protoc_insertion_point(field_set_allocated:Protocol.UC_MOVE.info)
}
...
// .Protocol.PosInfo info = 1;
inline bool MS_MOVE::_internal_has_info() const {
  return this != internal_default_instance() && _impl_.info_ != nullptr;
}
inline bool MS_MOVE::has_info() const {
  return _internal_has_info();
}
inline const ::Protocol::PosInfo& MS_MOVE::_internal_info() const {
  const ::Protocol::PosInfo* p = _impl_.info_;
  return p != nullptr ? *p : reinterpret_cast<const ::Protocol::PosInfo&>(
      ::Protocol::_PosInfo_default_instance_);
}
inline const ::Protocol::PosInfo& MS_MOVE::info() const {
  // @@protoc_insertion_point(field_get:Protocol.MS_MOVE.info)
  return _internal_info();
}
inline void MS_MOVE::unsafe_arena_set_allocated_info(
    ::Protocol::PosInfo* info) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.info_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Protocol.MS_MOVE.info)
}
inline ::Protocol::PosInfo* MS_MOVE::release_info() {
...
inline ::Protocol::PosInfo* MS_MOVE::unsafe_arena_release_info() {
  // @@protoc_insertion_point(field_release:Protocol.MS_MOVE.info)
  
  ::Protocol::PosInfo* temp = _impl_.info_;
  _impl_.info_ = nullptr;
  return temp;
}
inline ::Protocol::PosInfo* MS_MOVE::_internal_mutable_info() {
...
inline ::Protocol::PosInfo* MS_MOVE::mutable_info() {
  ::Protocol::PosInfo* _msg = _internal_mutable_info();
  // @@protoc_insertion_point(field_mutable:Protocol.MS_MOVE.info)
  return _msg;
}
inline void MS_MOVE::set_allocated_info(::Protocol::PosInfo* info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.info_);
  }
  ...
  _impl_.info_ = info;
  // @@protoc_insertion_point(field_set_allocated:Protocol.MS_MOVE.info)
}
